...
def calculate_metrics(folder1, folder2):
    ...
    for i, (fpath1, fpath2) in enumerate(zip(l1, l2)):
        ...
        assert img1.shape == img2.shape, f"Illegal shape: {img1.shape} vs {img2.shape} for {fpath1} and {fpath2}"
...
if __name__ == '__main__':
    folder1 = '/home/aistudio/output/gens' # path to the inpainted result
    folder2 = '/home/aistudio/val/val_img' # path to the GT
