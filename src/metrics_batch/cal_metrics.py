...
def calculate_metrics(folder1, folder2):
    ...
    print("Number of images in folder1:", len(l1))
    print("Images in folder1:", l1)
    print("Number of images in folder2:", len(l2))
    print("Images in folder2:", l2)
...
if __name__ == '__main__':
    # folder1 = '/home/aistudio/output/gens'
    folder1 = '/home/aistudio/output_coarse2fine/gens'
    folder2 = '/home/aistudio/val/val_img'
